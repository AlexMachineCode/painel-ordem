...
import { MasterTools } from "./_components/master-tools";
import { SquadTracker } from "./_components/squad-tracker";
// 1. IMPORTANDO O TRACKER AQUI
import { InitiativeTracker } from "./_components/iniciative-tracker";
      ...
      <div className="relative z-10 mx-auto max-w-[1600px] space-y-8">
        ...
        <div className="grid grid-cols-1 items-start gap-6 lg:grid-cols-3 xl:grid-cols-4">
          ...
          <div className="sticky top-24 flex flex-col gap-6 lg:col-span-1">
            {/* 2. ADICIONEI O COMPONENTE AQUI DENTRO DE UMA CAIXA */}
