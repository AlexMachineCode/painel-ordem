...
// Utilitário para classes (opcional, mas bom ter)
...
const containerVariants = {
  ...
  show: {
    opacity: 1,
    transition: {
      staggerChildren: 0.1, // Atraso entre cada item (efeito cascata)
      delayChildren: 0.3,
    },
  },
};
...
export default function PlayerPage() {
  ...
  // LOADING SCREEN (Melhorada com AnimatePresence para saída suave)
  if (isLoading) {
    return (
    ...
    >
      ...
      <div className="relative z-10 mx-auto max-w-7xl space-y-8 p-4 md:space-y-12 md:p-12">
        ...
        >
          ...
          <Link
            href="/admin"
            className="group relative self-start overflow-hidden rounded border border-zinc-900 bg-zinc-900/50 p-2 text-[10px] font-bold text-zinc-700 transition-all hover:text-green-500 md:self-auto md:text-xs"
          >
            <span className="relative z-10">🔒 [ SYSTEM_ACCESS ]</span>
      ...
      <div className="grid grid-cols-2 gap-3 sm:grid-cols-3 md:grid-cols-4 md:gap-4 lg:grid-cols-5">
        {pistasReveladas.map((pista, idx) => (
          <motion.div
            ...
            transition={{ delay: idx * 0.05 }} // Efeito cascata dentro da missão
          ...
          >
            ...
            >
              {/* Overlay verde ao passar o mouse */}
